...
<%
	String str=ac.validate();
	if(str.equals("success"))
	{
		session.setAttribute("name",ac.getRcnm());
   ...
   // final String to = "manishakhandelwal2611@gmail.com";
    ...
    String messg = bg+"\n"+loc+"\n"+cop+"\n"+qun+"\n"+tc+"\n"+pname+"\n"+gen+"\n"+rcnm+"\n"+rcno+"\n"+rdt+"\n\n\n\n"+
                    ...
                    +"It is obligatory for the replacer to replace the blood before the replacement date."+"\n"+ "Team RaktPlus";
    ...
    try
    {
        ...
        response.sendRedirect("Seeker11.jsp");
	...
	if(str.equals("Seeker1"))
	{
		response.sendRedirect("Seeker1.jsp");
	}
	if(str.equals("error"))
	{
